...
public class MapService {
	...
	public void ex1() {
		...
		System.out.println(map.put(1, "김밥"));
		System.out.println(map.put(2, "라면"));
		System.out.println(map.put(3, "떡볶이"));
		System.out.println(map.put(4, "돈까스"));
		System.out.println(map);
		System.out.println(map.put(4, "치즈 돈까스"));
	...
	public void ex2() {
		...
		// LinkedHashMap : 순서가 유지되는 HashMap
		...
		member.put("memberAge",23); // AutoBoxing 적용
