...
public class ExceptionService {
	public void ex1() throws IOException {
		...
		// 왜 빨간줄이 뜰까??
		// - read line() 메서드는 IOException 이라고 하는 예외를
		// 발생시킬(던질) 가능성이 있기 때문에
		// 그 상황에 대한 대비책(예외처리)을 하라고 경고하는 것.

		// Checked Exception :
		// 컴파일 단계에서 예외가 발생할 가능성이 있는 지
		// 반드시 확인해야하는 예외
	...
	public void ex2() {
		...
		try {
			...
			// 매개 변수에는 던져진 예외 객체를 저장할 수 있는 참조 변수를 작성.
	...
	public void ex3() {
		...
		try {
			...
			// It is aleady handled by the catch block for Exception
...
//			e.getMessage();
	...
	public void methodA() throws IOException {
		...
		methodB();
		// methodB()는 IOException을 던질 수도 있기 때문에
		// 호출 시 예외 처리 구문을 작성해야 된다.
	}
