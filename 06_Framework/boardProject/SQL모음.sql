...
CREATE USER boardProject IDENTIFIED BY "project1234";

-- 권한 부여
GRANT CONNECT, RESOURCE, CREATE VIEW TO project;
GRANT CONNECT, RESOURCE, CREATE VIEW TO boardProject;
...
SELECT * FROM USER_SYS_PRIVS; WHERE USERNAME = 'PROJECT';
SELECT * FROM USER_TAB_PRIVS; WHERE GRANTEE = 'PROJECT';
...
INSERT INTO MEMBER VALUES(
	SEQ_MEMBER_NO.NEXTVAL, 'user01@kh.or.kr', 'pass01!', '유저일', '01012341234',
	'04540,,서울시 중구 남대문로 120,,2층', NULL, DEFAULT, DEFAULT, DEFAULT
);
INSERT INTO MEMBER VALUES(
	SEQ_MEMBER_NO.NEXTVAL, 'user02@kh.or.kr', 'pass02!', '이번유저', '01043214321',
	'04540,,서울시 중구 남대문로 120,,2층', NULL, DEFAULT, DEFAULT, DEFAULT
);
INSERT INTO MEMBER VALUES(
	SEQ_MEMBER_NO.NEXTVAL, '1', '$2a$10$xbpptBq4CVB/tJqvoM573.wpsrDGcO6dwszDfBH1kjmRlRdWOxD9O', '테스트', '01011111111',
	'04540,,서울시 중구 남대문로 120,,2층', NULL, DEFAULT, DEFAULT, DEFAULT
);
COMMIT;
SELECT * FROM MEMBER;
...
-- 로그인 SQL
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME, MEMBER_PW, MEMBER_TEL, MEMBER_ADDR, PROFILE_IMG, AUTHORITY,
...
-- user01의 비밀번호 변경
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$xbpptBq4CVB/tJqvoM573.wpsrDGcO6dwszDfBH1kjmRlRdWOxD9O'
...
UPDATE MEMBER
SET MEMBER_NICKNAME = #{}, MEMBER_TEL = #{}, MEMBER_ADDR = #{}
WHERE MEMBER_NO = #{};
...
INSERT INTO "BOARD_TYPE" VALUES(SEQ_BOARD_CODE.NEXTVAL, '테스트게시판');
...
COMMIT;
SELECT * FROM "BOARD" WHERE BOARD_CODE=4;
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00001.jpg', 'cat1.jpg', 0, 1499);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00002.jpg', 'cat2.jpg', 0, 1498);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00003.jpg', 'cat3.jpg', 0, 1490);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00004.jpg', 'cat4.jpg', 0, 1487);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00005.jpg', 'cat5.jpg', 0, 1486);
...
INSERT INTO "BOARD_LIKE" VALUES(1499, 4);
COMMIT;
SELECT * FROM MEMBER;
...
-- 회원 프로필 이미지 변경
UPDATE MEMBER SET 
PROFILE_IMG = '/resources/images/member/ChatGPT_logo.svg.png'
WHERE MEMBER_NO=3;
...
INSERT INTO BOARD_LIKE VALUES(1499,5);

DELETE FROM BOARD_LIKE WHERE BOARD_NO = 1499 AND MEMBER_NO = 5;
...
SELECT * FROM BOARD B ORDER BY 1 DESC;

UPDATE BOARD SET BOARD_TITLE = 'ZZ' WHERE BOARD_NO=1504;
COMMIT;
...
--> 시퀀스 생성 구문을 작성하지 못함. (부적합)

-- INSERT + SUB QUERY
INSERT INTO "BOARD_IMG"
SELECT SEQ_IMG_NO.NEXTVAL, A.*
FROM (
SELECT '웹 접근 경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 0 IMG_ORDER, 1501 BOARD_NO
FROM DUAL

UNION ALL

SELECT '웹 접근 경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 1 IMG_ORDER, 1501 BOARD_NO
FROM DUAL

UNION ALL

SELECT '웹 접근 경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 2 IMG_ORDER, 1501 BOARD_NO
FROM DUAL

UNION ALL

SELECT '웹 접근 경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 3 IMG_ORDER, 1501 BOARD_NO
FROM DUAL
) A;
...
COMMIT;
DELETE FROM BOARD_IMG WHERE IMG_NO=22;
...
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 1', DEFAULT, DEFAULT, 1514, 3, NULL);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 2', DEFAULT, DEFAULT, 1514, 3, NULL);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1', DEFAULT, DEFAULT, 1514, 3, 1001);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-2', DEFAULT, DEFAULT, 1514, 3, 1001);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-3', DEFAULT, DEFAULT, 1514, 3, 1001);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1', DEFAULT, DEFAULT, 1514, 3, 1002);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-2', DEFAULT, DEFAULT, 1514, 3, 1002);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식의 자식 댓글 2-1-1', DEFAULT, DEFAULT, 1514, 3, 1006);
...
UPDATE "MEMBER" SET PROFILE_IMG ='/images/member/20230518165945_99297.jpg' WHERE MEMBER_NO = 3;
UPDATE "MEMBER" SET MEMBER_NICKNAME ='1' WHERE MEMBER_NO = 3;
