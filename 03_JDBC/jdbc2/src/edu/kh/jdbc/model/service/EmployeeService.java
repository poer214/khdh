...
public class EmployeeService {
	 ...
	 * @throws SQLException 
	 */
	public List<Employee> selectSalaryBetween(int a, int b) throws SQLException{
		Connection conn = getConnection();
		
		List<Employee> empList = dao.selectSalaryBetween(conn, a, b);
