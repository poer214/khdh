...
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL,'댓글 샘플 2번',DEFAULT,DEFAULT,2,1);
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL,'댓글 샘플 3번',DEFAULT,DEFAULT,3,2);
...
SELECT COUNT(*)
FROM "COMMENT" SUB
WHERE SUB.BOARD_NO = MAIN.BOARD_NO AND DELETE_FL = 'N'
) COMMENT_COUNT
FROM BOARD MAIN
JOIN MEMBER USING(MEMBER_NO)
WHERE DELETE_FL = 'N'
...
TO_CHAR(ENROLL_DT, 'YYYY"년" MM"월" DD"일" HH24:MI:SS') ENROLL_DATE 
FROM "MEMBER"
...
SELECT COUNT(*) RESULT FROM "MEMBER"
...
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL,'댓글 샘플 4번',DEFAULT,DEFAULT,1,2);

ROLLBACK;

SELECT * FROM "COMMENT"
WHERE COMMENT_NO = 1 AND MEMBER_NO = 1 AND BOARD_NO = 0;

SELECT * FROM "COMMENT"
		WHERE COMMENT_NO = 9 AND MEMBER_NO = 1 AND BOARD_NO = 2;
		
UPDATE "COMMENT"
SET COMMENT_CONTENT = 'BB'
WHERE COMMENT_NO = 9;
