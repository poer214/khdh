...
public class JDBCExample1 {
	public static void main(String[] args) {
		...
		try {
			...
			String port = ":1521"; // 내 컴퓨터 내 응용프로그램 번호
			// 9000 (강의장 DB서버 이용자)
			...
			String user = "kh_ldh"; // 계정명
			
			String pw = "oracle_ldh123A"; // 비밀번호
			...
			// jdbc:oracle:thin:@localhost:1521:ORCL,kh_ldh,oracle_ldh123A
			...
			while(rs.next()) {
				...
				// rs.next()
				// - ResultSet 객첸든 조회 결과를 한 번에 테이블로 다루는 것이 아닌
			...
			e.printStackTrace();
		} finally { // try에서 예외가 발생여부와 상관없이 수행
