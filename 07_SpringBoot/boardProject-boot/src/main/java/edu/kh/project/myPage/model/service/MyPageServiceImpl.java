...
public class MyPageServiceImpl implements MyPageService {
   ...
   // @Transactional의 rollbackFor 속성을 활용하면 된다
	...
	public int updateInfo(Member updateMember) {
		return myPageMapper.updateInfo(updateMember);
	}
...
//	@Transactional // UnChecked Exception 발생 시 rollback
	...
	public int changePw(String currentPw, String newPw, int memberNo) {
		...
		String encPw = myPageMapper.selectEncPw(memberNo);
		...
		if(bcrypt.matches(currentPw, encPw)) {
			...
			return myPageMapper.changePw(member);
		}
	...
	public int secession(String memberPw, int memberNo) {
		if(bcrypt.matches(memberPw, myPageMapper.selectEncPw(memberNo))) return myPageMapper.secession(memberNo);
		return 0;
	}
