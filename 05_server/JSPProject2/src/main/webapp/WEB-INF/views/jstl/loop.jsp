...
<body>
    ...
    count: 현재 반복의 횟수(1부터 시작)
    first: 현재 반복이 첫 번째인지 여부를 나타내는 boolean 값
    last: 현재 반복이 마지막인지 여부를 나타내는 boolean 값
    even: 현재 반복의 인덱스가 짝수인지 여부를 나타내는 boolean 값
    odd: 현재 반복의 인덱스가 홀수인지 여부를 나타내는 boolean 값
    </pre>
